...
/**
 * Employee is a class for an employee
...
public class Employee{
     ...
     * @param numberOfHours Employee's number of hours worked in a month
     */
     ...
     * @param other An Employee object to compare with
     */
     ...
     *  earned per month
     *  @return monthlySalary the number of hours worked multiplied by the hourly salary
     */
     ...
     *  i.e. 15% = 15.0
     *  @param percentage the percentage increase in salary, 15% = 15
     *  @return hourlySalary the hourly salary after the percentage increase
     */
