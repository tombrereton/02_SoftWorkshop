 ...
 * a Soduko puzzle. Note, a zero in the array
...
public class Soduko {
     ...
     */
    public Soduko(int[][] array) {
        this.array = array;
    }

    /**
     * Getter for 2d array representing Soduko puzzle
     *
    ...
    public String stringBuilder(int[][] a) {
        ...
        for (int row = 0; row <= numberOfRows * 2; row++) {
            for (int column = 0; column <= numberOfColumns * 2; column++) {
                if (row % 6 == 0 || row == 18) {
                    sodukoString += bigSeparatorLine;
                    break;
                } else if (row % 2 == 0) {
                    sodukoString += smallSeparatorLine;
                    break;
                } else if (row % 2 == 1 && column % 6 == 0 || column == 18) {
                    sodukoString = sodukoString + "||";
                } else if (row % 2 == 1 && column % 2 == 0) {
                    sodukoString = sodukoString + "|";
                } else if (row % 2 == 1 && column % 2 == 1) {
                    if ((a[row - (row / 2 + 1)][column - (column / 2 + 1)]) == 0) {
                        sodukoString = sodukoString + "   ";
                    } else {
                        sodukoString = sodukoString + String.format(" %d ", (a[row - (row / 2 + 1)][column - (column / 2 + 1)]));
                    }
                }
            }
