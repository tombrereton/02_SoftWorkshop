...
public class Weight{
    ...
    /**
     * @return the pounds to ounces conversion
     */
    ...
    public double getPounds() {
        this.pounds = this.getKilograms() * this.getKgToPound();
        return this.pounds;
    }
    /**
    ...
    public double getOunces() {
        this.ounces = this.getKilograms() * this.getKgToPound() * this.getPoundToOunce();
        return this.ounces;
    }
     ...
     * @param other A Weight object to compare with
     */
     ...
     *
     * @return the weight's kilograms, pounds, and ounces
     */
    public String toString() {
        return String.format(
                ...
                this.getKilograms(), this.getPounds(), this.getOunces());
    }
}
