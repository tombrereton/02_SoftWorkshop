...
public class StudentTest {
    ...
    @Test
    public void assertEqualsDateOfBirth() {
    ...
    @Test
    public void assertEqualsDegreeProgramme() {
    ...
    @Test
    public void assertEqualsSetName() {
    ...
    @Test
    public void assertEqualsSetDateOfBirth() {
    ...
    @Test
    public void assertEqualsSetStudentID() {
    ...
    @Test
    public void assertEqualsSetDegreeProgramme() {
