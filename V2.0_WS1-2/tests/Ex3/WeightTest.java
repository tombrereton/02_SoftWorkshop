...
public class WeightTest {
    ...
    @Test
    public void getPoundTest() {
        // expected weight in pounds
        double expected = 176.3699;

        assertEquals("The expected weight in pounds does not match the actual: ", expected, w1.getPound(), 0.0001);
    }

    @Test
    public void getOunceTest() {
        // expected weight in ounces
        double expected = 2821.91695;

        assertEquals("The expected ounce does not match the actual: ", expected, w1.getOunce(), 0.0001);
    }
    ...
    public void setKilogramsTest() {
        ...
        assertEquals("The expected weight in pounds does not match the actual: ", expectedPound, w1.getPound(), 0.0001);
        assertEquals("The expected weight in ounces does not match the actual: ", expectedOunce, w1.getOunce(), 0.0001);
    }
